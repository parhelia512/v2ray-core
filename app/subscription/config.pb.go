...
func file_app_subscription_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_subscription_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_app_subscription_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
