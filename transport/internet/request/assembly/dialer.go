...
func dialRequest(ctx context.Context, dest net.Destination, streamSettings *internet.MemoryStreamConfig) (net.Conn, error) {
	...
	assemblerConfigInstance, err := transportConfiguration.Assembler.GetInstance()
	if err != nil {
	...
	roundtripperConfigInstance, err := transportConfiguration.Roundtripper.GetInstance()
	if err != nil {
