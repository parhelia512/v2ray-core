...
// Source: github.com/v2fly/v2ray-core/v4/common/log (interfaces: Handler)
//
// Generated by this command:
//
//	mockgen -package mocks -destination testing/mocks/log.go -mock_names Handler=LogHandler github.com/v2fly/v2ray-core/v4/common/log Handler
//
